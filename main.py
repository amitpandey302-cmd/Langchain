...
# )
#
# #llmopenAI = ChatOpenAI(temperature=0, model="gpt-5")
# llama = ChatOllama(temperature=0, model="qwen3:0.6b")
#
# chain = summary_prompt_template | llama
# response = chain.invoke(input={"information": information})
print("Hello from    langchain")
#result = agent.invoke({"messages": HumanMessage(content="What is the weather in Noida")})
result = agent.invoke({"messages": HumanMessage(content="Search for 3 job postings for an ai engineer using Langchain in the Delhi-NCR of linkedin and list their details")})
print(result)
